var World = {
	...
	createOverlays: function createOverlaysFn() {
		...
		var pagePokemonButton = this.createWwwButton("http://www.amazon.com/Pok%C3%A9mon-X-nintendo-3ds/dp/B0053B5RGI/ref=sr_1_1?ie=UTF8&qid=1417906826&sr=8-1&keywords=pokemon+x", 0.5, {
			offsetX: 0.5,
			offsetY: 0.0,
			zOrder: 1
		});
		...
		var pageZeldaButton = this.createWwwButton("http://www.amazon.com/Legend-Zelda-Between-Worlds-nintendo-3ds/dp/B00GANWVJE/ref=sr_1_1?ie=UTF8&qid=1417906033&sr=8-1&keywords=zelda+link+between+worlds", 0.5, {
			offsetX: 0.5,
			offsetY: 0.0,
			zOrder: 1
		});
		...
		var pageZelda = new AR.Trackable2DObject(this.tracker, "zeldalinkbetweenworlds", {
			drawables: {
				cam: [overlayZelda, pageZeldaButton]
			}
		});
	},
